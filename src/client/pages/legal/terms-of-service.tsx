      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-semibold prose-h2:text-2xl prose-h2:mt-8 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-6 prose-h3:mb-3 prose-p:leading-relaxed prose-p:text-foreground prose-li:text-foreground prose-a:text-primary prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-em:text-foreground">
            ...
            <p>
              We are <strong>MacDev</strong>, doing business as <strong>NanoStudio</strong> ("Company," "we," "us," "our").
            </p>
            <p>
              We operate the website{' '}
              <a href="https://nanostudioai.com" target="_blank" rel="noopener noreferrer">
            ...
            <p>
              <strong>NanoStudio is a Software-as-a-Service (SaaS) platform</strong> that provides AI-powered image generation and editing tools. Our service allows users to:
            </p>
            <ol>
              <li>Generate images from text descriptions (text-to-image)</li>
              <li>Edit and modify existing images using AI (image-to-image)</li>
              <li>Manage their image creation history with undo/redo capabilities</li>
              <li>Store generated images securely in cloud storage</li>
            </ol>
            <p>
              Users access our platform through a web application and authenticate using their Google account. We operate on a subscription-based model where users purchase monthly or yearly plans that include a set number of credits. Each image generation or editing operation consumes credits from the user's account.
            </p>
            <p>
              Our service utilizes third-party AI models (fal.ai and Google Gemini) to process image generation requests, Stripe for payment processing, Google Cloud Storage for image storage, and Google OAuth for user authentication.
            </p>
            <p>
              Users retain ownership of the images they generate through our platform and can download, share, or use them for personal or commercial purposes, subject to our acceptable use policy.
            </p>
            ...
            <p>
              ...
              <Link to="/privacy-policy" className="text-primary hover:underline">
                nanostudioai.com/privacy-policy
              </Link>
            ...
            <h2 id="copyrightyes">13. Copyright Infringements</h2>
            <p>
            ...
            <p>
              These Legal Terms are governed by and interpreted following the laws of Germany, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. MacDev and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Bavaria, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in Germany, or in the EU country in which you reside.
            </p>
